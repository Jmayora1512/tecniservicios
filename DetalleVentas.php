...
<p><h2>Detalles de Venta</h2> </p>
<p>Las ventas hasta el momento son:</p>
<?php 
...
<table width="283" border="0">
  ...
  <tr>
    <td bgcolor="#FFFADD">&nbsp;</td>
    <td bgcolor="#FFFADD">&nbsp;</td>  
    <td bgcolor="#FFFADD"><form id= "form1" name="form1" action="confirmarVenta.php" method="post"> 
      <input  type="submit" name="ConfirmarVenta" id="ConfirmarVenta" value="Confirmar Venta" />
    </form></td>
