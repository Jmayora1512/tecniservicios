...
<h1>Registro Modificado Usuario</h1>
...
$Estados_idEstados=$_POST['Estado2'];
  ...
  $RecuperoArray=EncontrarRegU($Cedula_Usuario);

  $a=GrabarCambiosU($Cedula_Usuario,$Nombre_Usuario,$Apellido_Usuario,$Login,$Clave,$Correo_Usuario,$Telefono_Usuario,$Celular_Usuario,$Fecha_Usuario,$Direccion_Usuario,$Nivel_Usuario_idNivel_Usuario,$Estados_idEstados);
 // echo $RecuperoArray;
?>
