...
<?php 
	// $idProveedores=$_POST['idProveedores2'];
	$RIF=$_POST['RIF2'];
	$Nombre_Contacto=$_POST['Nombre2'];
    $Apellido_Contacto=$_POST['Apellido2'];
    $Nombre_Comercial=$_POST['Comercio2'];
    $Direccion_Comercio=$_POST['Direccion2'];
    $Fecha_Ingreso=$_POST['Fecha2'];
    $Telefono=$_POST['Telefono2'];
    $Celular_Contacto=$_POST['Celular2'];
...
<form id="form1" name="form1" method="post" action="ModificarProveedores.php" >
  <table width="249" border="0" align="left">
    <tr>
      <td width="171">&nbsp;</td>
      <td width="68">&nbsp;</td> 
      <input name="idProveedores2" type="hidden" value="<?php echo $idProveedores ?>"/></td>
    </tr>

    <tr>
      <td>RIF:</td>
      <td><label for="RIF"></label>
      	<input type="text" name="RIF2" id="RIF" value="<?php echo $RIF ?>"/></td>
    </tr>

    <tr>
      <td>Nombre:</td>
      <td><label for="Codigo"></label>
      	<input type="text" name="Nombre2" id="Nombre" value="<?php echo $Nombre_Contacto ?>"/></td>
    </tr>

    <tr>
      <td>Apellido:</td>
      <td><label for="Apellido"></label>
      	<input type="text" name="Apellido2" id="Apellido2" value="<?php echo $Apellido_Contacto ?>"/></td>
    </tr>  

    <tr>
      <td>Comercio:</td>
      <td><label for="Comercio"></label>
      	<input type="text" name="Comercio2" id="Comercio" value="<?php echo $Nombre_Comercial ?>"/></td>
    </tr>
 
     <tr>
      <td>Direccion:</td>
      <td><label for="Direccion"></label>
        <input type="text" name="Direccion2" id="Direccion" value="<?php echo $Direccion_Comercio ?>"/></td>
    </tr>  
    ...
    <tr>
      ...
      <td><label for="Telefono"></label>
      	<input type="text" name="Telefono2" id="Telefono" value="<?php echo $Telefono ?>"/></td>
    </tr> 

    <tr>
      <td>Celular:</td>
      <td><label for="Celular"></label>
      	<input type="text" name="Celular2" id="Celular" value="<?php echo $Celular_Contacto ?>"/></td>
    </tr> 
    ...
    <tr>
      ...
      <td><label for="Estado"></label>
        ...
        <SELECT name="Estado2" id="Estado2">
      	...
      	<!-- <input type="text" name="Estado2" id="Categoria_idCategoria" value="<?php echo $Estados_idEstados ?>"/></td> -->
    </tr> 
