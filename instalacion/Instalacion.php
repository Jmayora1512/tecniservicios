...
//Creamos la Base de Datos
 mysql_query("CREATE DATABASE INVENTARIO".$BasedeDatos,$Conexion)or die("No existe la base de datos.".mysql_error());
//***********

 //Crear tablas
 mysql_select_db($BasedeDatos,$Conexion)or die("Error al seleccionar la base de datos.".mysql_error());
$sql="
-- phpMyAdmin SQL Dump
-- version 4.0.9
