...
$sql="INSERT INTO proveedores (RIF,Nombre_Contacto,Apellido_Contacto,Nombre_Comercial,Direccion_Comercio,Fecha_Ingreso,Telefono,Celular_Contacto,Estados_idEstados) 
values ('".$RIF."','".$Nombre."','".$Apellido."','".$Comercio."','".$Direccion."','".$Fecha."','".$Telefono."','".$Celular."','".$Estado."')";
// echo $sql;
