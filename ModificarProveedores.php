...
<h1>Registro Modificado Proveedor</h1>
...
<?php 
 ...
 //    $Fecha_Creado=$_POST['Fecha2'];
  ...
  // $RecuperoArray=EncontrarRegP($RIF);

  $a=GrabarCambiosP($RIF,$Nombre_Contacto,$Apellido_Contacto,$Nombre_Comercial,$Direccion_Comercio,$Fecha_Ingreso,$Telefono,$Celular_Contacto,$Estados_idEstados);
 // echo $RecuperoArray;
?>
