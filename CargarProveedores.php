...
<h1>Cargar Proveedores</h1>
<h4>Tecni Servicios E.E.C.C. C.A</h4>

<form id="form1" name="form1" method="post" action="RecibirProveedores.php"  enctype="multipart/form-data">
    ...
    <tr>
     ...
     <tr>
      ...
      <td><label for="Comercio"></label>
        <input type="text" name="Comercio" id="Comercio"></td>
    </tr> 
