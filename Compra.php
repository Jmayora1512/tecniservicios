...
<!--      <tr>
    ...
    <tr>
      ...
      <td bgcolor="#FFFADD">
      <form action="DetalleCompra.php" method="post" name="compra">
        <input name="id_txt" type="hidden" value="<?php echo $Id ?>" />
        <input name="nombre" type="hidden" value="<?php echo $Nombre ?>" />
        <input name="precio" type="hidden" value="<?php echo $PrecioC ?>" />
...
<p><a href="DetalleCompra.php">Ver Detalles Compras</a></p>
